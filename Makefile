...
servers/%/image.raw: images/database-mariadb-10-4-8-bionic.tar images/database-it490-app.tar images/application-it490-gateway.tar images/rabbitmq-it490-rabbitmq.tar images/api-it490-imdbscraper.tar
